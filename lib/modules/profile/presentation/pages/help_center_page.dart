      ...
      children: <Widget>[
              ...
              child: Material(
                ...
                child: InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Icon(Icons.arrow_back, color: AppTheme.getTheme().colorScheme.background),
                  ),
                ),
              ),
            ),
        ...
        Padding(
          ...
          child: Text(
            ...
            style: new TextStyle(fontSize: 22, fontWeight: FontWeight.w700, color: AppTheme.getTheme().colorScheme.background),
          ),
        ),
        Padding(
